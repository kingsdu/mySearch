...
import com.mySearch.domain.CountWebInfo;
import com.retrieve.util.FileUtils;


public class WebExtractorUtils {
	...
	public WebExtractorUtils(Document doc) {
		this.doc = doc;
	}
	...
	public static void main(String args[]){
		...
		//E:\test\hetritrix\output\sina\18\mirror\news.sina.com.cn\c\2017-09-30\doc-ifymksyw5133862.shtml
		StringBuilder html = FileUtils.readHtml(path);
		//		writeHtml(html.toString());
		Document doc = Jsoup.parse(html.toString(), url);
		WebExtractorUtils m = new WebExtractorUtils(doc);
